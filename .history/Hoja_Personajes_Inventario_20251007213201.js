      ...
      <table class="table table-sm align-middle">
        ...
        ${armadurasOrden.map(a => `
          <tr data-itemid="${a.id}">
            ...
            <td><input class="form-control form-control-sm" name="armadura" title="${o.especial|| ''}" value="${a.armadura || ''}" ></td>
      ...
      <table class="table table-sm align-middle">
        ...
        ${armasOrden.map(w => `
          <tr data-itemid="${w.id}">
            ...
            <td><input class="form-control form-control-sm" name="arma" title="${w.danio || ''} + ' ' ${o.especial|| ''}" value="${w.arma || ''}"></td>
            <td>
