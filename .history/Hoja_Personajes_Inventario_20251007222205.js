...
const armadurasOrden = Array.isArray(pj?.inventario?.armaduras) ? pj.inventario.armaduras : [];
const armasOrden = Array.isArray(pj?.inventario?.armas) ? pj.inventario.armas : [];
