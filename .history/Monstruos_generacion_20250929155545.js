    ...
    ? `<strong>Hechizos:</strong> ` +
      (hechizos || []).map(h => `
          <span 
            ...
            data-tippy-content="<div style='font-size:20px; text-align:center; border:5px solid orange; border-radius:10px; padding:5px;'>
    <img src='img/hechizos/${h.Tipo}.png' style='width:100px;height:100px;display:block;margin:0 auto 5px auto;'>
    ${h.Efecto}
</div>"
              ${h.Categoría}: ${h.Tipo}
          </span>`
