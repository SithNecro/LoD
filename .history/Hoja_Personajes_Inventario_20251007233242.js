          ...
          ${armadurasOrden.map(a => {
            ...
            return `
              <tr data-itemid="${a.id || ''}" data-cat="arm">
                <td><input    style="width:40px; text-align:center; vertical-align:middle;" title="Equipado" type="checkbox" disabled ${a.equipado ? 'checked' : ''}></td>
    ...
    const tblArmas = `
      ...
      <table class="table table-sm table-dark table-striped">
        <thead><tr>
                <th  style="width:40px; text-align:center; vertical-align:middle;" title="Equipado">⚙️</th>
        <th>Arma</th>
         <th  style="width:40px; text-align:center; vertical-align:middle;"title="Mano"><th>✋🤚</th>
          ...
          ${armasOrden.map(w => {
            ...
            return `
              <tr data-itemid="${w.id || ''}" data-cat="arma">
               <td><input    style="width:40px; text-align:center; vertical-align:middle;" title="Equipado" type="checkbox" disabled  ${w.equipado ? 'checked' : ''}></td>
