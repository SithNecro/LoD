    ...
    <table class="table table-sm align-middle">
      <thead>
        <tr>
          ...
          <th style="width:110px;text-align:center;vertical-align:middle;">⚙️</th>
        </tr>
      </thead>
      <tbody>
        ${objetosOrden.map(o => `
          <tr data-itemid="${o.id}">
            ...
            <td style="position:relative; text-align:center;">
              <button class="btn btn-sm btn-secondary" data-action="acciones">⚙️ Acciones</button>
            </td>
          </tr>`).join('')}
      </tbody>
    </table>`;
...
window.renderInventarioPreview = async function (slot) {
  try {
    ...
    // OBJETOS (Nombre con tooltip Uso, Cantidad, Peso, Acciones)
    const tblObjs = `
      <h6 class="mt-2 mb-1">🧰 Objetos</h6>
      <table class="table table-sm table-dark table-striped">
        <thead>
          <tr>
            <th>Nombre</th><th>Cant.</th><th>Peso</th>
            <th style="width:110px;text-align:center;vertical-align:middle;">⚙️ Acciones</th>
          </tr>
        </thead>
        <tbody>
          ${objetosOrden.map(o => `
            <tr data-itemid="${o.id || ''}" data-cat="obj">
              ...
              <td class="text-center" style="position:relative;">
                <button class="btn btn-sm btn-outline-secondary" data-action="slot-acciones">⚙️ Acciones</button>
              </td>
            </tr>`).join('')}
        </tbody>
      </table>`;

    // ARMADURAS (Equip., Armadura/tooltip Especial, Cob., Def., Dur/Rot, Peso, Acc.)
    const tblArmad = `
      <h6 class="mt-2 mb-1">🛡️ Armaduras</h6>
      <table class="table table-sm table-dark table-striped">
        <thead>
          <tr>
            <th>Equip.</th><th>Armadura</th><th>Cob.</th><th>Def.</th><th>Dur./Rot.</th><th>Peso</th>
            <th style="width:110px;text-align:center;vertical-align:middle;">⚙️ Acciones</th>
          </tr>
        </thead>
        <tbody>
    ...
    // ARMAS (Equip., Arma/tooltip Especial, Mano, Daño, Peso, Acc.)
    const tblArmas = `
      <h6 class="mt-2 mb-1">⚔️ Armas</h6>
      <table class="table table-sm table-dark table-striped">
        <thead>
          <tr>
            <th>Equip.</th><th>Arma</th><th>Mano</th><th>Daño</th><th>Peso</th>
            <th style="width:110px;text-align:center;vertical-align:middle;">⚙️ Acciones</th>
          </tr>
        </thead>
        <tbody>
          ${armasOrden.map(w => `
            <tr data-itemid="${w.id || ''}" data-cat="arma">
              <td><input type="checkbox" ${w.equipado ? 'checked' : ''}></td>
