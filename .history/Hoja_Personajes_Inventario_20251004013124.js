...
window.openInventarioEditor = async function (slot) {
    ...
    await Swal.fire({
        ...
        width: '90%', // ⬅️ aquí el cambio: 90% del ancho de la pantalla
        customClass: {
          popup: 'sai-popup',
          title: 'sai-title',
        ...
        didOpen: () => {
            ...
            // 🔹 Declaramos una sola vez y reutilizamos
      ...
      <table class="table table-sm align-middle ">
        ...
        ${personaje.inventario.objetos.map(o => `
          <tr data-itemid="${o.id}">
            ...
            <td><p class="form-select form-select-sm" name="durabilidad">${mkOpts(11, o.durabilidad ?? 0)}</select>${mkOpts(11, o.durabilidad ?? 0)}</td>
