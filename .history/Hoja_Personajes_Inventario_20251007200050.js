        ...
        <div id="grpObj" class="col-12" style="display:none;">
          <div class="row g-2">
            ...
            <div class="col-6 col-md-2">
             ...
             <button type="button" id="btnAddObj" class="btn btn-success btn-add-objeto">➕ Añadir</button>
            </div>
          </div>
        </div>
...
<div class="col-12 col-md-2">
  ...
  <small id="armCobList" class="d-block mt-1"></small>
            ...
            <div class="col-12 col-md-8">
             <button type="button" id="btnAddArmadura" class="btn btn-success btn-add-armadura">➕ Añadir</button>
            </div>
          </div>
        </div>
        ...
        <div id="grpArma" class="col-12" style="display:none;">
          <div class="row g-2">
            ...
            <div class="col-6 col-md-2">
              ...
              <div class="col-12 col-md-8">
             <button type="button" id="btnAddArma" class="btn btn-success btn-add-arma">➕ Añadir</button>
            </div>
          </div>
        </div>
      </div>
