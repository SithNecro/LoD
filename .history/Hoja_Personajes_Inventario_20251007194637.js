...
<div class="col-12 col-md-4">
  ...
  await Swal.fire({
    ...
    didOpen: () => {
      ...
      const cobertura = Array.from(cobSel?.selectedOptions || []).map(o => o.value).join(',');
      ...
      // Si cargas datos previos del formulario, llama una vez para pintar el <small>:
      ...
      if (btnArm) btnArm.addEventListener('click', async () => {
        ...
        const item = {
          ...
          equipado: false,
          armadura: nombre,
          cobertura, // ← guarda "Cabeza,Pecho,..." en texto, como querías
