        ...
        <div id="grpArm" class="col-12" style="display:none;">
          <div class="row g-2">
            ...
            <div class="col-12 col-md-4">
              ...
              <small id="armCobList" class="text-muted"></small>
            </div>
            <div class="col-6 col-md-2">
    ...
    try {
      ...
      const tblObjs = `
        ...
        <table class="table table-sm table-dark table-striped">
          <thead>
            <tr><th>Nombre</th><th>Cant.</th><th></th><th>Peso</th></tr>
          </thead>
          <tbody>
            ${objetos.map(o => `
      ...
      const tblArmad = `
        ...
        <table class="table table-sm table-dark table-striped">
          <thead>
            <tr><th>Equip.</th><th>Armadura</th><th>Cob.</th><th>Def.</th><th>Durab.</th><th>Trasp.</th><th>Peso</th></tr>
          </thead>
          <tbody>
            ${armaduras.map(a => `
