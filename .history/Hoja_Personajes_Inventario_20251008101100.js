...
<h6 style="border-top:3px solid #cfa75f; padding-top:6px; margin-top:10px;">Armas</h6>
  ...
  `;
          ...
          // Posicionar respecto al botón (coordenadas de la ventana)
          const r = btn.getBoundingClientRect();
          let top = Math.round(r.bottom + 6);
          let left = Math.round(r.left);

          // Inserta primero para medir ancho y ajustar si se sale por la derecha
          ...
          // Cierre si se hace click fuera, si se hace scroll en el modal o si se redimensiona
          const close = (e) => {
          ...
          // Importante: no retornamos aquí el control de flujo del handler;
          // dejamos que el propio click en los botones del menú (traspasar/eliminar)
          // sea capturado por el mismo onClick existente más abajo.
          return;
        }
