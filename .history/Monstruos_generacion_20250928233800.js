...
// Inicializar tooltip para el tipo
const tipoEl = wrapper.querySelector(".tipo-monstruo");
if (tipoEl) {
    ...
    tippy(tipoEl, {
        ...
        theme: 'carta',
        placement: 'right',
        content: `<img src="${imgSrc}" style="width:300px;height:700px;object-fit:contain;">`,
    });
}