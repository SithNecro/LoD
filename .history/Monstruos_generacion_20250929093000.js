...
function renderCard(monster, category, armas, armaduras, hechizos, color = "#fff", vidas = null, save = true) {
  ...
  <span class="tipo-monstruo" 
    ...
    vidaItems.forEach((item, idx) => {
        ...
        btnSaqueo.addEventListener("click", () => {
            // Obtener el tipo de saqueo (puedes usar monster.tipo o definir otro campo)
            const tipoSaqueo = monster.tipo.split("/")[0].trim();
